...
const SignupPage: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const user = await signup(form.email, form.password, form.name,form.phone );
            ...
            <div>
              ...
              <div className="relative mt-1">
                <input
                  ...
                  className="w-full pl-3 pr-4 py-2.5 rounded-lg border border-stone-200 text-stone-900 placeholder:text-stone-400 bg-white focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-transparent transition-all"
                />
              </div>
            </div>
