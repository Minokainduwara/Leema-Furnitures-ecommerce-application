      ...
      <div className="flex flex-wrap gap-3 items-center justify-between">
        <div className="relative flex-1 min-w-[200px] max-w-md">
          ...
          <input
            ...
            className="w-full pl-9 pr-3 py-2 rounded-lg border text-stone-600 border-stone-200 text-sm focus:ring-2 focus:ring-amber-200 outline-none"
          />
        </div>
        <select
          value={statusFilter}
          onChange={(e) => setStatusFilter(e.target.value)}
          className="px-3 py-2 rounded-lg border border-stone-200 text-sm bg-white text-stone-600"
        >
          <option value="all" className="text-stone-600">All statuses</option>
