...
const Sidebar: React.FC<SidebarProps> = ({
  ...
  return (
    <aside
      className="flex flex-col items-center w-64 min-h-screen py-8 px-4"
      style={{ background: "#111827" }}
    >
      {/* Title */}
      <h2
        className="text-white font-black tracking-widest text-sm uppercase mb-8"
        style={{
      ...
      {/* Avatar */}
      <div
        className="w-24 h-24 rounded-full overflow-hidden mb-4 border-4 border-white/20 shadow-xl"
      ...
      <p className="text-white/50 text-xs mb-10 tracking-widest">
        USER ID:{user.id}
      </p>
          ...
          return (
            <button
              ...
              style={{
                ...
                border: isActive
                  ? "1px solid rgba(125,212,196,0.4)"
