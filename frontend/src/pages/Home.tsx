...
function Home() {
  return (
    <div>
      <Header />
      <Body>
        <div className="bg-gradient-to-br from-amber-50 via-yellow-50 to-orange-50 py-16 px-5 md:px-10">
          <div>
      ...
      <Body>
        <div>
          <div className="bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900 min-h-20 flex justify-around items-center text-white p-4 rounded-lg shadow-lg ">
            <div className="text-lg font-bold hover:text-orange-400 ">
              SUPER MAX
            </div>
          ...
          <div className="bg-gradient-to-br from-amber-100 via-orange-50 to-yellow-50 min-h-[700px] flex flex-col md:flex-row justify-around items-center gap-y-10 p-10 relative overflow-hidden">
            <div className="gap-3 justify-center flex flex-col items-start max-w-md ">
              <h2 className="text-4xl  md:text-5xl font-bold text-gray-800 pt-2 pl-4">
                Our Services
              </h2>
              <h6 className="text-gray-600  text-lg md:text-xl font-medium pt-2 pl-4">
                We provide high-quality, stylish,and{" "}
              </h6>
              <h6 className="text-gray-600  text-lg md:text-xl font-medium  pl-4">
                {" "}
                durable furniture with reliable delivery
              </h6>
              <h6 className="text-gray-600 text-lg md:text-xl font-medium  pl-4">
                {" "}
              ...
              <div className="mt-6 pl-4 ">
                <img
                  ...
                  alt="service"
                  className="w-[300px] h-[350px] object-cover rounded-xl shadow-xl hover:scale-105 transition duration-500 justify-center"
                />
              </div>
            </div>
            ...
            <div className="w-[400px] grid sm:grid-cols-1   md:grid-cols-2  gap-6 justify-center">
              <div className="bg-white  font-semibold rounded-3xl p-5 w-[200px] h-[200px] shadow-lg hover:shadow-2xl font-sans  text-center flex flex-col justify-center items-center ">
                ...
                <h3 className="font-bold text-lg md:text-xl text-gray-700">
                  Free Delivery
                </h3>
                <p className="text-sm md-text-base text-gray-500">
                  Fast and safe delivery to your home.
                </p>
              </div>
              ...
              <div className="bg-white  font-semibold rounded-3xl p-5 w-[200px] h-[200px] shadow-lg hover:shadow-2xl font-sans  text-center flex flex-col justify-center items-center ">
                ...
                <p className="text-sm md-text-base text-gray-500">
                  Professional furniture setup service.
                </p>
              </div>
              <div className="bg-white  font-semibold rounded-3xl p-5 w-[200px] h-[200px] shadow-lg hover:shadow-2xl font-sans  text-center flex flex-col justify-center items-center ">
                <h3 className=" text-5xl animate-bounce">🔧</h3>
                ...
                <p className="text-sm md-text-base text-gray-500">
                  Reliable furniture repair support.
                </p>
              </div>
            </div>
          </div>
