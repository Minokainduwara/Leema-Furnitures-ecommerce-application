...
import Header from "../components/seller-component/Header";
import Body from "../components/seller-component/Body";
import Footer from "../components/seller-component/Footer";
import Product from "../components/seller-component/Product";
